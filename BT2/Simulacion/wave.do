...
add wave -noupdate -expand -group SPI -radix hexadecimal /test_top/dut/SPI/dato_tx
add wave -noupdate -expand -group SPI -radix hexadecimal -childformat {{/test_top/dut/SPI/dato_rx(7) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(6) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(5) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(4) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(3) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(2) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(1) -radix hexadecimal} {/test_top/dut/SPI/dato_rx(0) -radix hexadecimal}} -subitemconfig {/test_top/dut/SPI/dato_rx(7) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(6) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(5) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(4) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(3) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(2) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(1) {-height 15 -radix hexadecimal} /test_top/dut/SPI/dato_rx(0) {-height 15 -radix hexadecimal}} /test_top/dut/SPI/dato_rx
add wave -noupdate -expand -group SPI /test_top/dut/SPI/init_tx
add wave -noupdate -expand -group SPI /test_top/dut/SPI/init_rx
add wave -noupdate -expand -group SPI /test_top/dut/SPI/data_ready
add wave -noupdate -expand -group SPI /test_top/dut/SPI/ena_out
add wave -noupdate -expand -group SPI /test_top/dut/SPI/ena_in
add wave -noupdate -expand -group SPI /test_top/dut/SPI/nWR
add wave -noupdate -expand -group SPI -radix binary -childformat {{/test_top/dut/SPI/adr_reg(4) -radix hexadecimal} {/test_top/dut/SPI/adr_reg(3) -radix hexadecimal} {/test_top/dut/SPI/adr_reg(2) -radix hexadecimal} {/test_top/dut/SPI/adr_reg(1) -radix hexadecimal} {/test_top/dut/SPI/adr_reg(0) -radix hexadecimal}} -subitemconfig {/test_top/dut/SPI/adr_reg(4) {-height 15 -radix hexadecimal} /test_top/dut/SPI/adr_reg(3) {-height 15 -radix hexadecimal} /test_top/dut/SPI/adr_reg(2) {-height 15 -radix hexadecimal} /test_top/dut/SPI/adr_reg(1) {-height 15 -radix hexadecimal} /test_top/dut/SPI/adr_reg(0) {-height 15 -radix hexadecimal}} /test_top/dut/SPI/adr_reg
add wave -noupdate -expand -group SPI -radix hexadecimal /test_top/dut/SPI/dato_in_reg
add wave -noupdate -expand -group SPI -radix hexadecimal /test_top/dut/SPI/dato_out_reg
add wave -noupdate -expand -group SPI /test_top/dut/SPI/tds_min
add wave -noupdate -expand -group SPI /test_top/dut/SPI/tdh_min
add wave -noupdate -expand -group SPI /test_top/dut/SPI/tacces_max
add wave -noupdate -expand -group SPI /test_top/dut/SPI/tz_max
...
add wave -noupdate -expand -group com_spi -radix hexadecimal /test_top/dut/SPI/com_SPI/dato_rx
...
add wave -noupdate -expand -group com_spi /test_top/dut/SPI/com_SPI/desplazar_reg_dato_out
...
add wave -noupdate -expand -group com_spi /test_top/dut/SPI/com_SPI/hay_datos_en_buf_retransmision
add wave -noupdate -expand -group com_spi /test_top/dut/SPI/com_SPI/buf_data_tx
...
add wave -noupdate /test_top/dut/master_spi_3_4_hilos/nCS
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3468139280 ps} 0} {{Cursor 2} {2662500 ps} 0}
...
update
WaveRestoreZoom {0 ps} {17966208 ps}
